    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            Try
                ...
                cmm.Parameters.AddWithValue("@Anio", Math.Round(Convert.ToSingle(TextBox12.Text), 2))
                cmm.Parameters.AddWithValue("@Salario_minimo", Math.Round(Convert.ToSingle(TextBox1.Text), 2))
                cmm.Parameters.AddWithValue("@Aux_transporte", Math.Round(Convert.ToSingle(TextBox2.Text), 2))
                cmm.Parameters.AddWithValue("@Salario_dia", Math.Round(Convert.ToSingle(TextBox3.Text), 2))
                cmm.Parameters.AddWithValue("@Hora_diurna", Math.Round(Convert.ToSingle(TextBox4.Text), 2))
                cmm.Parameters.AddWithValue("@Hora_nocturna", Math.Round(Convert.ToSingle(TextBox5.Text), 2))
                cmm.Parameters.AddWithValue("@Hora_dominical", Math.Round(Convert.ToSingle(TextBox11.Text), 2))
                cmm.Parameters.AddWithValue("@Hora_festivo", Math.Round(Convert.ToSingle(TextBox17.Text), 2))
                cmm.Parameters.AddWithValue("@Recargo_nocturno", Math.Round(Convert.ToSingle(TextBox6.Text), 2))
                cmm.Parameters.AddWithValue("@Recargo_dominical", Math.Round(Convert.ToSingle(TextBox7.Text), 2))
                cmm.Parameters.AddWithValue("@Recargo_festivo", Math.Round(Convert.ToSingle(TextBox8.Text), 2))
                cmm.Parameters.AddWithValue("@Salud", Math.Round(Convert.ToSingle(TextBox9.Text), 2))
                cmm.Parameters.AddWithValue("@Pension", Math.Round(Convert.ToSingle(TextBox10.Text), 2))
...
#Region "Métodos"
    ...
    Private Sub cargarDatos()
        ...
        If Not valores.Count() = 0 Then
            ...
            TextBox3.Text = Convert.ToSingle(Convert.ToSingle(valores.ElementAt(0)) / 30)
            TextBox4.Text = valores.ElementAt(2)
            TextBox5.Text = valores.ElementAt(3)
            TextBox11.Text = valores.ElementAt(4)
            TextBox17.Text = valores.ElementAt(5)
            TextBox6.Text = valores.ElementAt(6)
            TextBox7.Text = valores.ElementAt(7)
            TextBox8.Text = valores.ElementAt(8)
            TextBox9.Text = valores.ElementAt(9)
            TextBox10.Text = valores.ElementAt(10)
        End If
    End Sub
