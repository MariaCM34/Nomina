...
CREATE TABLE Ingresar (
	Numero_Documento nvarchar(12) primary key NOT NULL,
	Tipo_Documento nvarchar (25) NOT NULL,
...
CREATE TABLE Hoja_de_vida (
	...
	Tipo_documento nvarchar (25) NOT NULL,
	Numero_documento nvarchar(12) primary key,
	Fecha_expedicion date NOT NULL,
	Lugar_expedicion int NOT NULL,
	Fecha_nacimiento date NOT NULL,
	Lugar_nacimiento int NOT NULL,
	Telefono nvarchar (10) NOT NULL,
	Celular nvarchar (10) NOT NULL,
	Correo_electronico nvarchar (35) NOT NULL,
	Estado_civil nvarchar (25) NOT NULL,
	Ocupacion nvarchar (45) NOT NULL,
	Departamento int NOT NULL,
	Ciudad int NOT NULL, 
	direccion nvarchar (50) NOT NULL,
	Numero_de_cuenta nvarchar (25) NOT NULL,
	Banco nvarchar (20) NOT NULL,
	Nombre_de_contacto nvarchar (50) NOT NULL,
	Telefono_contacto nvarchar (10) NOT NULL,
	EPS nvarchar (20) NOT NULL,
	AFP nvarchar (20) NOT NULL,
	ARL nvarchar (20) NOT NULL

	FOREIGN KEY (Departamento) REFERENCES Departamentos(id), 
	FOREIGN KEY (Ciudad) REFERENCES Municipios(id),
	FOREIGN KEY (Lugar_expedicion) REFERENCES Municipios(id), 
...
CREATE TABLE Contrato (
	...
	Nume_documento nvarchar (12) NOT NULL,
	Contrato_laboral image NOT NULL,
	Tipo_Contrato nvarchar (25) NOT NULL,
	Actividad nvarchar (15) NOT NULL,
	Cargo nvarchar (50) NOT NULL,
	Por_concepto_de nvarchar (25) NOT NULL,
	salario_base decimal (10,2) NOT NULL,
	tiempo_corte int NOT NULL,
	Inicio_contrato date NOT NULL,
	Fin_contrato date
	CONSTRAINT fk_contrato FOREIGN KEY (Nume_documento) REFERENCES Hoja_de_vida (Numero_documento)
)

select*from Contrato

CREATE TABLE OtrosSi (
	id int identity (1, 1) primary key,
	otrosi image NOT NULL,
	id_contrato int NOT NULL
	CONSTRAINT fk_otrosi FOREIGN KEY (id_contrato) REFERENCES Contrato (id)
)

CREATE TABLE Comunicados (
	id int identity (1,1) primary key,
	Nume_documento nvarchar (12),
	Archivos image
	CONSTRAINT fk_comunicados FOREIGN KEY (Nume_documento) REFERENCES Hoja_de_vida (Numero_documento)
)

CREATE TABLE Certificado_laboral (
	id int identity (1,1) primary key,
	Nume_documento nvarchar(12) NOT NULL,
	Certificado_laboral image NOT NULL
	CONSTRAINT fk_certificado FOREIGN KEY (Nume_documento) REFERENCES Hoja_de_vida (Numero_documento)
)

CREATE TABLE Archivos (
	id int identity (1,1),
	Num_documento nvarchar (12) primary key,
	documento image NOT NULL,
	RUT image NOT NULL,
	Tarjeta_profesional image NOT NULL,
	Hoja_de_vida image NOT NULL,
	Certificado_academico image NOT NULL,
	Certificado_laboral image NOT NULL,
	Certificado_bancario image NOT NULL,
	Certificado_Eps image NOT NULL,
	AFP image NOT NULL,
	Antecedentes image NOT NULL,
	Examen_ingreso image NOT NULL,
	Otros image NOT NULL,
	CONSTRAINT fk_archivos FOREIGN KEY (Num_documento) REFERENCES Hoja_de_vida (Numero_documento)
)

CREATE TABLE ValoresxAnio (
	Anio int primary key,
	Salario_minimo decimal (10,2) not null,
	Aux_transporte decimal (10,2) not null,
	Salario_dia decimal (10,2) not null,
	Hora_diurna decimal (10,2) not null,
	Hora_nocturna decimal (10,2) not null,
	Hora_dominical decimal (10,2) not null,
	Hora_festivo decimal (10,2) not null,
	Recargo_nocturno decimal (10,2) not null,
	Recargo_dominical decimal (10,2) not null,
	Recargo_festivo decimal (10,2) not null,
...
CREATE TABLE Prestamos(
	...
	Num_documento nvarchar(12) NOT NULL,
	Fecha_prestamo date NOT NULL,
	Fecha_fin_prestamo date NOT NULL,
	Metodo_pago nvarchar(25) NOT NULL,
	Valor_prestamo decimal (10,2) NOT NULL

	CONSTRAINT fk_prestamo FOREIGN KEY (Num_documento) REFERENCES Hoja_de_vida (Numero_documento)
)

CREATE TABLE Colilla_pago (
	id int identity primary key,
	id_colilla_empleado nvarchar(5) NOT NULL,
	Numero_documento nvarchar(12) NOT NULL,
	Nombre nvarchar (50) NOT NULL,
	Apellido nvarchar (50) NOT NULL,
	Salario_base decimal (10,2) NOT NULL,
	...
	Aux_transporte decimal (10,2) NOT NULL,
	Hrs_diurnas decimal (10,2) NOT NULL,
	Hrs_nocturnas decimal (10,2) NOT NULL,
	Hrs_dominicales decimal (10,2) NOT NULL,
	Hrs_festivas decimal (10,2) NOT NULL,
	Total_Hrs decimal (10,2) NOT NULL,
	Rec_nocturno decimal (10,2) NOT NULL,
	Rec_dominical decimal (10,2) NOT NULL,
	Rec_festivo decimal (10,2) NOT NULL,
	Total_Rec decimal (10,2) NOT NULL, 
	Incapacidades decimal (10,2) NOT NULL,
	Licencias decimal (10,2) NOT NULL,
	Otros_devengados decimal (10,2),
	Descripcion_otros_dev nvarchar(100),
	Total_devengado decimal (10,2) NOT NULL, 
	Salud decimal (10,2) NOT NULL,
	Pension decimal (10,2) NOT NULL,
	Otras_deducciones decimal (10,2),
	Descripcion_otras_ded nvarchar(100),
	Retencion decimal (10,2) NOT NULL,
	Prestamos decimal (10,2) NOT NULL,
	Total_deducciones decimal (10,2) NOT NULL,
	Neto_pagar decimal (10,2) NOT NULL

	CONSTRAINT fk_colilla FOREIGN KEY (Numero_documento) REFERENCES Hoja_de_vida (Numero_documento)
)

CREATE TABLE Documentos_nomina(
	id int identity primary key,
	Documento image NOT NULL,
	fecha date not null,
...
CREATE TABLE Cuenta_cobro (
	...
	Concepto_de nvarchar(300) NOT NULL,
	Otros_devengados decimal (10,2),
	Descripcion_otros_dev nvarchar(100),
	Otras_deducciones decimal (10,2),
	Descripcion_otras_ded nvarchar(100),
	...
	CONSTRAINT fk_cuenta FOREIGN KEY (Numero_documento) REFERENCES Hoja_de_vida (Numero_documento),
	CONSTRAINT fk_cuenta_contrato FOREIGN KEY (Contrato) REFERENCES contrato (id)
)

CREATE TABLE Totales_nomina(
	Total_colilla_pago decimal(10,2),
	Total_cuenta_cobro decimal(10,2),
	Total_nominas decimal(10,2)
)
...
CREATE TABLE Liquidaciones (
	...
	Basico decimal (10,2) NOT NULL,
	Aux_transporte decimal (10,2) NOT NULL,
	Descripcion_prestacion nvarchar(50) NOT NULL,
	Prima decimal(10, 2) not null,
	Cesantias decimal(10, 2) not null,
	Int_cesantias decimal(10, 2) not null,
	Vacaciones decimal(10, 2) not null,
	Total_liquidado decimal (10,2) NOT NULL

	CONSTRAINT fk_liquidacion FOREIGN KEY (Numero_documento) REFERENCES Hoja_de_vida (Numero_documento),
)
...
--reiniciar identity DBCC CHECKIDENT ('documentos_nomina', RESEED, 2) 
--Saber vlr identity SELECT IDENT_CURRENT('Hoja_de_vida') 

-------------INSERTAR / ACTUALIZAR------------------

CREATE PROCEDURE sp_mant_registro --Insertar usuarios
(
	@Numero_Documento nvarchar(12), @Tipo_Documento nvarchar(25), @Nombre nvarchar(50), @Contrasena nvarchar(15)
)
as
begin
	if NOT EXISTS(SELECT * FROM Ingresar WHERE Numero_documento = @Numero_documento)
		begin
			insert into Ingresar values (@Numero_Documento, @Tipo_Documento, @Nombre, @Contrasena)
		end
end
GO

CREATE PROCEDURE sp_mant_hoja_vida --Insertar o modificar hojas de vida
(
	@Nombre nvarchar(50), @Apellido nvarchar (50), @Tipo_documento nvarchar(25), @Numero_documento nvarchar(12), @Fecha_expedicion date,
	@Lugar_expedicion int, @Fecha_nacimiento date, @Lugar_nacimiento int, @Telefono nvarchar(10), @Celular nvarchar(10), 
	@Correo_electronico nvarchar(35), @Estado_civil nvarchar(25), @Ocupacion nvarchar(45), @Departamento int, @Ciudad int, 
	@direccion nvarchar(50), @Numero_de_cuenta nvarchar(25), @Banco nvarchar(20), @Nombre_de_contacto nvarchar(50),
	@Telefono_contacto nvarchar(10), @EPS nvarchar(20), @AFP nvarchar(20), @ARL nvarchar(20)
)
as
begin
	if EXISTS(SELECT * FROM Hoja_de_vida WHERE Numero_documento = @Numero_documento)
		begin
			update Hoja_de_vida set
				...
				Lugar_nacimiento = ISNULL(@Lugar_nacimiento, Lugar_nacimiento), 
				...
				Ocupacion = ISNULL(@Ocupacion, Ocupacion), 
				Departamento = ISNULL(@Departamento, Departamento),
				Ciudad = ISNULL(@Ciudad, Ciudad), 
				direccion = ISNULL(@direccion, direccion), 
				Numero_de_cuenta = ISNULL(@Numero_de_cuenta, Numero_de_cuenta),
				Banco = ISNULL(@Banco, Banco), 
				Nombre_de_contacto = ISNULL(@Nombre_de_contacto, Nombre_de_contacto), 
		...
		begin
			INSERT INTO Hoja_de_vida VALUES (@Nombre, @Apellido, @Tipo_documento, @Numero_documento, 
				...
				@direccion, @Numero_de_cuenta, @Banco, @Nombre_de_contacto, @Telefono_contacto, @EPS, @AFP, @ARL);
		end
end
GO

CREATE PROCEDURE sp_mant_archivo --Insertar archivos
(
	@Num_documento nvarchar (12), @documento image, @RUT image, @Tarjeta_profesional image, @Hoja_de_vida image,
	@Certificado_academico image, @Certificado_laboral image, @Certificado_bancario image, @Certificado_Eps image,
	@AFP image, @Antecedentes image, @Examen_ingreso image, @Otros image
)
as
begin
	if not exists (select * from Archivos where Num_documento = @Num_documento)
		begin
			insert into Archivos values (@Num_documento, @documento, @RUT, @Tarjeta_profesional, @Hoja_de_vida, @Certificado_academico,
...
CREATE PROCEDURE sp_mant_contrato --Insertar o modificar contratos
(
	@id int, @Nume_documento nvarchar(12), @Contrato_laboral image, @Tipo_Contrato nvarchar(25),
	@Actividad nvarchar(15), @Cargo nvarchar(50), @Por_concepto_de nvarchar(25), @salario_base decimal (10, 2),
	@tiempo_corte int, @Inicio_contrato date, @Fin_contrato date
)
as
begin
	if not exists(select * from contrato where Nume_documento = @Nume_documento) --Insertar
		begin
			insert into Contrato values (@Nume_documento, @Contrato_laboral, @Tipo_Contrato, @Actividad,
						@Cargo, @Por_concepto_de, @salario_base, @tiempo_corte, @Inicio_contrato, @Fin_contrato)
		end 
	else --Actualizar
		begin
			update Contrato set
				Cargo = ISNULL(@Cargo, Cargo),
				Por_concepto_de = ISNULL(@Por_concepto_de, Por_concepto_de),
				salario_base = ISNULL(@salario_base, salario_base),
				Fin_contrato = @Fin_contrato
			where id = @id and Nume_documento = @Nume_documento
		end 
end
GO

CREATE PROCEDURE sp_mant_otrosi --Insertar otro si
(
	@otrosi image, @id_contrato int
)
as
begin
	insert into OtrosSi values (@otrosi, @id_contrato)
end
GO

CREATE PROCEDURE sp_mant_comunicado --Insertar o modificar comunicados
(
	@vlr int, @id int, @Nume_documento nvarchar(12), @Archivos image
)
as
begin
	if @vlr = 0
		begin
			insert into Comunicados values (@Nume_documento, @Archivos)
		end
	else
		begin
			if (select DATALENGTH(@Archivos)) <> 1
				begin
					update Comunicados set Archivos = @Archivos where id = @id and Nume_documento = @Nume_documento
				end
		end 
end
GO

CREATE PROCEDURE sp_mant_certificado_laboral --Insertar o modificar certificados laborales
(
	@vlr int, @id int, @Nume_documento nvarchar(12), @Certificado_laboral image
)
as
begin
	if @vlr = 0
		begin
			insert into Certificado_laboral values (@Nume_documento, @Certificado_laboral)
		end
	else
		if (select DATALENGTH(@Certificado_laboral)) <> 1
			begin
				update Certificado_laboral set Certificado_laboral = @Certificado_laboral where id = @id and Nume_documento = @Nume_documento

			end
end
GO

CREATE PROCEDURE sp_mant_valores_pred --Insertar o modificar valores predeterminados
(
	@Anio int, @Salario_minimo float, @Aux_transporte float, @Salario_dia float, @Hora_diurna float, @Hora_nocturna float, @Hora_dominical float, 
	@Hora_festivo float, @Recargo_nocturno float, @Recargo_dominical float, @Recargo_festivo float, @Salud float, @Pension float
)
as
begin
	if not exists (select * from ValoresxAnio where anio = @Anio)
		begin
			insert into ValoresxAnio values (@Anio, @Salario_minimo, @Aux_transporte, @Salario_dia, @Hora_diurna, @Hora_nocturna,
				@Hora_dominical, @Hora_festivo, @Recargo_nocturno, @Recargo_dominical, @Recargo_festivo, @Salud, @Pension)
		end
	else
		begin
			update ValoresxAnio set 
			Salario_minimo = @Salario_minimo, 
			Aux_transporte = @Aux_transporte,
			Salario_dia = @Salario_dia, 
			Hora_diurna = @Hora_diurna, 
			Hora_nocturna = @Hora_nocturna,
			Hora_dominical = @Hora_dominical, 
			Hora_festivo = @Hora_festivo, 
...
CREATE PROCEDURE sp_mant_prestamo --Insertar préstamos
(
	@Num_documento nvarchar(12), @Fecha_fin_prestamo date, @Metodo_pago nvarchar(25), @Valor_prestamo float 
)
as
begin
	insert into Prestamos values (@Num_documento, getdate(), @Fecha_fin_prestamo, @Metodo_pago, @Valor_prestamo)
end
GO

CREATE PROCEDURE sp_mant_colilla_pago --Insertar colillas de pago
(
	@id_colilla_empleado nvarchar(5), @Numero_documento nvarchar(12), @Nombre nvarchar (50), @Apellido nvarchar (50), @Salario_base decimal (10,2), @Fecha_inicial date,
	@Fecha_final date, @Basico decimal (10,2), @Aux_transporte decimal (10,2), @Hrs_diurnas decimal (10,2), @Hrs_nocturnas decimal (10,2),
	@Hrs_dominicales decimal (10,2), @Hrs_festivas decimal (10,2), @Total_Hrs decimal (10,2), @Rec_nocturno decimal (10,2), @Rec_dominical decimal (10,2),
	@Rec_festivo decimal (10,2), @Total_Rec decimal (10,2), @Incapacidades decimal (10,2), @Licencias decimal (10,2), @Otros_devengados decimal (10,2),
	@Descripcion_otros_dev nvarchar(100), @Total_devengado decimal (10,2), @Salud decimal (10,2), @Pension decimal (10,2), @Otras_deducciones decimal (10,2),
	@Descripcion_otras_ded nvarchar(100), @Retencion decimal (10,2), @Prestamos decimal (10,2), @Total_deducciones decimal (10,2), @Neto_pagar decimal (10,2) 
)
as
begin
	if not exists(select * from Colilla_pago where Numero_documento = @Numero_documento and Fecha_inicial = @Fecha_inicial and Fecha_final = @Fecha_final) --Insertar
		begin
			insert into Colilla_pago values (
				@id_colilla_empleado, @Numero_documento, @Nombre, @Apellido, @Salario_base, @Fecha_inicial, @Fecha_final, @Basico, @Aux_transporte, @Hrs_diurnas, @Hrs_nocturnas,
				@Hrs_dominicales, @Hrs_festivas, @Total_Hrs, @Rec_nocturno, @Rec_dominical,	@Rec_festivo, @Total_Rec, @Incapacidades, @Licencias, @Otros_devengados,
				@Descripcion_otros_dev, @Total_devengado, @Salud, @Pension, @Otras_deducciones,	@Descripcion_otras_ded, @Retencion, @Prestamos, @Total_deducciones, @Neto_pagar
			)
			update totales_nomina set Total_colilla_pago = Total_colilla_pago + @Neto_pagar, Total_nominas = Total_nominas + @Neto_pagar
		end
end
GO

CREATE PROCEDURE sp_mant_cuenta_cobro --Insertar cuentas de cobro
(
	@Numero_documento nvarchar(12), @Nombre nvarchar (50), @Apellido nvarchar (50), @Salario_base decimal (10,2), @Fecha_inicial date,
	@Fecha_final date, @Basico decimal (10,2), @Contrato int, @Concepto_de nvarchar(300), @Otros_devengados decimal (10,2),
	@Descripcion_otros_dev nvarchar(100), @Otras_deducciones decimal (10,2), @Descripcion_otras_ded nvarchar(100), @Retencion decimal (10,2),
	@Prestamos decimal (10,2), @Neto_pagar decimal (10,2) 
)
as
begin
	if not exists(select * from Cuenta_cobro where Numero_documento = @Numero_documento and Fecha_inicial = @Fecha_inicial and Fecha_final = @Fecha_final) --Insertar
		begin
			insert into Cuenta_cobro values (
				@Numero_documento, @Nombre, @Apellido, @Salario_base, @Fecha_inicial, @Fecha_final, @Basico, @Contrato, @Concepto_de, 
				@Otros_devengados, @Descripcion_otros_dev, @Otras_deducciones, @Descripcion_otras_ded, @Retencion, @Prestamos, @Neto_pagar
			)
			update totales_nomina set Total_cuenta_cobro = Total_cuenta_cobro + @Neto_pagar, Total_nominas = Total_nominas + @Neto_pagar
		end
end
GO

CREATE PROCEDURE sp_mant_liquidaciones --Insertar liquidaciones
(
	@Numero_documento nvarchar(12), @Nombre nvarchar (50), @Apellido nvarchar (50), @Fecha_inicial date,
	@Fecha_final date, @Basico decimal (10,2), @Aux_transporte decimal (10,2), @Descripcion_prestacion nvarchar(50),
	@Prima decimal(10, 2), @Cesantias decimal(10, 2), @Int_cesantias decimal(10, 2), @Vacaciones decimal(10, 2), @Total_liquidado decimal (10,2)
)
as
begin
	insert into Liquidaciones values (@Numero_documento, @Nombre, @Apellido, @Fecha_inicial, @Fecha_final, @Basico, @Aux_transporte, 
		@Descripcion_prestacion, @Prima, @Cesantias, @Int_cesantias, @Vacaciones, @Total_liquidado)
end
GO

CREATE PROCEDURE sp_mant_documentos --Insertar documentos
(
	@Documento image, @fecha date, @tipo_contrato nvarchar(40)
)
as
begin
	insert into Documentos_nomina values (@Documento, @fecha, @tipo_contrato)
end
GO
...
CREATE PROCEDURE sp_eliminar_hdv --Eliminar hojas de vida
(
	@Numero_documento nvarchar(12)
)
as
begin
	if EXISTS(SELECT * FROM Hoja_de_vida WHERE Numero_documento = @Numero_documento)
		begin
			DELETE FROM Contrato where Nume_documento = @Numero_documento
			DELETE FROM Comunicados where Nume_documento = @Numero_documento
			DELETE FROM Certificado_laboral where Nume_documento = @Numero_documento
			DELETE FROM Archivos where Num_documento = @Numero_documento
			DELETE FROM Hoja_de_vida where Numero_documento = @Numero_documento
		end 
	else
		return
end
...
CREATE PROCEDURE sp_eliminar_archivo --Eliminar archivos
(
	@Num_documento nvarchar(12)
)
as
begin
	DELETE FROM Archivos where Num_documento = @Num_documento
end
GO

CREATE PROCEDURE sp_eliminar_contrato --Eliminar contratos
(
	@id int, @Nume_documento nvarchar(12)
)
as
begin
	DELETE FROM Contrato WHERE id = @id and Nume_documento = @Nume_documento
end
GO

CREATE PROCEDURE sp_eliminar_comunicado --Eliminar comunicados
(
	@id int, @Nume_documento nvarchar(12)
)
as
begin
	DELETE FROM Comunicados WHERE id = @id AND Nume_documento = @Nume_documento
end
GO

CREATE PROCEDURE sp_eliminar_certificado_laboral --Eliminar certificado laboral
(
	@id int, @Nume_documento nvarchar(12)
)
as
begin
	DELETE FROM Certificado_laboral WHERE id = @id AND Nume_documento = @Nume_documento
end
GO

CREATE PROCEDURE sp_eliminar_otrosi --Eliminiar otros si
(
	@id_contrato int
)
as
begin
	DELETE FROM OtrosSi WHERE id_contrato = @id_contrato
end
GO
...
INSERT INTO Ingresar VALUES ('1001233854','Cédula','Maria Camila Martinez','34112156')
GO

INSERT INTO Totales_nomina VALUES (0, 0, 0)
...
EXEC sp_mant_valores_pred 2020, 877803, 102854, 29260, 25, 75, 75, 75, 35, 75, 75, 4, 4
GO
